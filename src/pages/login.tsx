...
// Inline SVG icons to avoid any external icon library
const FacebookIcon = () => (
  ...
  return (
    <div>
      ...
      <input
        ...
        style={{
          ...styles.input,
          borderColor: focused ? '#1266f1' : '#ccc',
          boxShadow: focused ? '0 0 0 2px rgba(18,102,241,0.15)' : 'none',
        }}
      ...
      <div style={styles.row}>
        ...
        <div style={styles.leftCol}>
          <h1 style={styles.heading}>
            The best offer <br />
            <span style={styles.headingSpan}>for your business</span>
          </h1>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.inputRow}>
              <div style={styles.inputGroup}>
                <InputField label="First name" id="form1" type="text" />
              </div>
              <div style={styles.inputGroup}>
                <InputField label="Last name" id="form2" type="text" />
              </div>
            </div>

            <div style={styles.inputWrapper}>
              <InputField label="Email address" id="form3" type="email" />
            </div>

            <div style={styles.inputWrapper}>
              <InputField label="Password" id="form4" type="password" />
            </div>
            ...
            <button
              style={{
                ...styles.signUpBtn,
                backgroundColor: btnHover ? '#0d52c7' : '#1266f1',
              }}
            ...
            <div style={styles.socialRow}>
              {[
                ...
                <button key={label} style={styles.socialBtn} aria-label={label} title={label}>
                  {icon}
                </button>
              ))}
            </div>
